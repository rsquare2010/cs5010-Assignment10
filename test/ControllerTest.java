...
/**
 * This is a test class used to test the EmulatorControllerImpl class works with the
 * ModelExtnImpl the StockEmulator application.
 */
public class ControllerTest {
  ...
  public void controllerTestSummaryPortfolioScreen() {
    ...
    controller.start(model, view);
    String expectedOutput = "Cost basis is: $\t5010.0\n";
    expectedOutput += "Value is: $\t7076.465679115377\n";
    expectedOutput = appendMenu(expectedOutput);
    System.out.println(fos.toString());
    assertTrue(fos.toString().endsWith(expectedOutput));
  }
